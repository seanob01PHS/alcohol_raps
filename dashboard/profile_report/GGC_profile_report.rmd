...
<div class = "warning_box">
Management Information only, not for onward distribution
This information has been released for management information purposes only. The data have not been adjusted to protect against potential disclosure risks. Please see the bottom of the "General Notes" tab under the "Notes" page.
</div>
...
indicator_data_shared <- indicator_data %>%
  map(~.x %>% map(~ .x %>% 
                    ...
                    mutate(sparkline=NA) %>% 
                    SharedData$new( key=~iz, group = "indicator")))
...
```{r ha_hscp_selector}
filter_select("select_ha", "HSCP", indicator_data_shared[["Alcohol-related hospital admissions"]][["vals"]], ~hscp, multiple=TRUE)
```
...
indicator_table(indicator_data[["Alcohol-related hospital admissions"]][["vals"]],
                indicator_data_shared[["Alcohol-related hospital admissions"]][["vals"]],
                type = "val",
                sparkline_type = "line")
...
indicator_table(indicator_data[["Alcohol-related hospital admissions"]][["change_ini"]],
                indicator_data_shared[["Alcohol-related hospital admissions"]][["change_ini"]],
                type = "change",
...
indicator_table(indicator_data[["Alcohol-related hospital admissions"]][["change_rolling"]],
                indicator_data_shared[["Alcohol-related hospital admissions"]][["change_rolling"]],
                type = "change",
